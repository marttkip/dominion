<div id="tabs-content-bottom">
            ...
            <div class="ui-tabs-panel clearfix" id="panel-1">
                <ul id="nav-sidebar-bottom" class="clearfix">
                    ...
                    <li><a href="#" class="clearfix">
                        <figure><img src="<?php echo site_url()?>assets/themes/braink/images/icon-sidebar-3.png" alt="Location" /></figure>
                        <strong class="title-nav-sidebar">Live Chat</strong>
                        Talk with our Customer Service or our student and alumni
                        </a></li>
                    <li><a href="#" class="clearfix">
                        <figure><img src="<?php echo site_url()?>assets/themes/braink/images/icon-sidebar-4.png" alt="Library and Research" /></figure>
            ...
            <div class="ui-tabs-panel clearfix" id="panel-4">
                <div class="flexslider slider-partners">
                    <ul class="slides">
                        <li><a href="#"><img src="http://placehold.it/163x100" data-retina="http://placehold.it/326x200" alt="Hawlett Package" /></a></li>
                        <li><a href="#"><img src="http://placehold.it/163x100" data-retina="http://placehold.it/326x200" alt="Google Play" /></a></li>
                        <li><a href="#"><img src="http://placehold.it/163x100" data-retina="http://placehold.it/326x200" alt="Linkedin" /></a></li>
                        <li><a href="#"><img src="http://placehold.it/163x100" data-retina="http://placehold.it/326x200" alt="Google" /></a></li>
                        <li><a href="#"><img src="http://placehold.it/163x100" data-retina="http://placehold.it/326x200" alt="Ebay" /></a></li>
                        <li><a href="#"><img src="http://placehold.it/163x100" data-retina="http://placehold.it/326x200" alt="Hawlett Package" /></a></li>
                        <li><a href="#"><img src="http://placehold.it/163x100" data-retina="http://placehold.it/326x200" alt="Google Play" /></a></li>
                        <li><a href="#"><img src="http://placehold.it/163x100" data-retina="http://placehold.it/326x200" alt="Linkedin" /></a></li>
                        <li><a href="#"><img src="http://placehold.it/163x100" data-retina="http://placehold.it/326x200" alt="Google" /></a></li>
